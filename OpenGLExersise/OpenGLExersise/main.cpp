...
void RenderText(Shader &s, std::string text, GLfloat x, GLfloat y, GLfloat scale, glm::vec3 color,int VBO)
{
	s.use();
...
int SSAO()
{
	...
	// build and compile shaders
	// -------------------------
	Shader shaderGeometryPass("shaders/AdvancedLighting/9.ssao_geometry.vert", "shaders/AdvancedLighting/9.ssao_geometry.frag");
	Shader shaderLightingPass("shaders/AdvancedLighting/9.ssao.vert", "shaders/AdvancedLighting/9.ssao_lighting.frag");
	Shader shaderSSAO("shaders/AdvancedLighting/9.ssao.vert", "shaders/AdvancedLighting/9.ssao.frag");
	Shader shaderSSAOBlur("shaders/AdvancedLighting/9.ssao.vert", "shaders/AdvancedLighting/9.ssao_blur.frag");
...
{
	//open window
	GLFWwindow* window = GenerateWindow("RenderText_0");
	if (window == nullptr) { return -1; }
	//init shader
	Shader shader("shaders/Text/textSource.vert", "shaders/Text/textSource.frag");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//render ...
		glBindVertexArray(VAO);
		RenderText(shader, "This is sample text", 25.0f, 25.0f, 1.0f, glm::vec3(0.5, 0.8f, 0.2f),VBO);
		RenderText(shader, "(C) LearnOpenGL.com", 540.0f, 570.0f, 0.5f, glm::vec3(0.3, 0.7f, 0.9f),VBO);
		glBindVertexArray(0);
